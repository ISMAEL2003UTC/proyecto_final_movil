...
class _ProductoScreenState extends State<ProductoScreen> {
  ...
  String obtenerNombreCategoria(int? id) {
    ...
    final cat = categorias.firstWhere(
      (c) => c.id == id,
      orElse: () =>
          CategoryModels(id: 0, nombre: 'Desconocida', descripcion: ''),
    );
    return cat.nombre;
  }
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () =>
                                          eliminarProducto(prod.id as int),
                                    ),
                                  ],
                                ),
                              ],
                      ...
                      children: [
                        ...
                        Text(
                          productos
                              .fold(
                                0.0,
                                (sum, prod) => sum + (prod.costo * prod.stock),
                              ) // este operador fold va recorriendo todos los productos y va acumulando su total
                              .toStringAsFixed(
                                2,
